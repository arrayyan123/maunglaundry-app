    ...
    <>
        <div ref={homeRef} class="relative bg-gradient-to-r from-purple-600 to-blue-600 h-screen text-white overflow-hidden">
            ...
            <div class="relative z-10 md:p-36 p-10 flex flex-col justify-center items-center h-full text-center">
                <h1 class="md:text-5xl text-4xl font-bold leading-tight mb-4">Maung Laundry</h1>
                ...
                <a href="/customer/login" class="bg-red-500 mt-4 text-white hover:bg-red-300 py-2 px-6 rounded-full text-lg font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg">Mulai Sekarang</a>
            </div>
        </div>
    </>
  )
