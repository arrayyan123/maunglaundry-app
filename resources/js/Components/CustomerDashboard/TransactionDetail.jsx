        ...
        <div className="max-w-8xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-200">
            <div className="mb-6 text-black">
                ...
                <div className="mt-6 flex flex-col md:flex-row md:space-x-4 space-y-4 md:space-y-0 items-center">
                    {transaction?.status_job !== 'done' && transaction?.status_job !== 'pending' && transaction?.status_job !== 'cancel' && (
                        <button
                            onClick={() => {
                    ...
                    {transaction?.status_payment === 'unpaid' && transaction?.status_job !== 'cancel' && (
